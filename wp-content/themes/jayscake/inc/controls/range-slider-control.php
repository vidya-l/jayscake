...
class Animal_Pet_Store_Range_Slider extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_style( 'jays_cake-range-control-styles', get_parent_theme_file_uri( '/assets/css/controls/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'jays_cake-range-control-scripts', get_parent_theme_file_uri( '/assets/js/controls/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
