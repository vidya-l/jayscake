	...
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<div class="page-header">
				<?php if ( have_posts() ) : ?>
					<h1 class="page-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s', 'jays-cake' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				<?php else : ?>
					<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'jays-cake' ); ?></h1>
				<?php endif; ?>
			</div>		
			<?php
	        $jays_cake_sidebar_layout = get_theme_mod( 'jays_cake_sidebar_post_layout','right');
	        if($jays_cake_sidebar_layout == 'left'){ ?>
		        <div class="row m-0">
		          	...
		          	<div class="col-lg-8 col-md-8">
			            ...
			            <?php if ( have_posts() ) :
							...
							endwhile; // End of the loop.
								...
								<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'jays-cake' ); ?></p>
								<?php
									get_search_form();
		        ...
		        <div class="clearfix"></div>
		    <?php }else if($jays_cake_sidebar_layout == 'right'){ ?>
		        <div class="row m-0">
		          	<div class="col-lg-8 col-md-8">
		    ...
		    <?php }else if($jays_cake_sidebar_layout == 'full'){ ?>
		        <div class="full">
		    ...
		    <?php }else if($jays_cake_sidebar_layout == 'three-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($jays_cake_sidebar_layout == 'four-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($jays_cake_sidebar_layout == 'grid'){ ?>
		        <div class="row m-0">
